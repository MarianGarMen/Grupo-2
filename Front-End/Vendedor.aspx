<%@ Page Title="Administrar Vendedores" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vendedor.aspx.cs" Inherits="Front_End.Contact" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Mantenimiento Vendedor</h6>
        </div>
        <div class="card-header py-3">
            <asp:LinkButton NavigateUrl="#" runat="server" CssClass="btn btn-primary btn-user btn-block" Text="Agregar Vendedor" data-toggle="modal" data-target="#registerModal"/>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <asp:GridView ID="gvVendedor" runat="server" AutoGenerateColumns="false" HorizontalAlign="Center" 
                    CssClass="table table-bordered" width="100%" cellspacing="0" DataKeyNames="CodVendedor" OnRowEditing="gvVendedor_RowEditing"
                    OnRowCancelingEdit="gvVendedor_RowCancelingEdit" OnRowUpdating="gvVendedor_RowUpdating" OnRowDeleting="gvVendedor_RowDeleting">
                    <Columns>
                        <asp:TemplateField HeaderText="Código Vendedor">
                            <ItemTemplate>
                                <asp:Label  Text='<%# Eval("CodVendedor") %>' runat="server"></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txtCodVendedor" CssClass="form-control form-control-user " runat="server" Text='<%# Eval("CodVendedor") %>' ReadOnly></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
